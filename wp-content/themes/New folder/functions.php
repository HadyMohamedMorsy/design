...
function arphabet_widgets_init_secound() {
...
add_action( 'widgets_init', 'arphabet_widgets_init_secound' );

function arphabet_widgets_init_thired() {
...
add_action( 'widgets_init', 'arphabet_widgets_init_thired' );
